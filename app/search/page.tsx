...
const fetchProducts = async (searchParams: { page?: number; q?: string }) => {
  const link = !searchParams.page
    ? "https://dummyjson.com/products/search?limit=10&q=" + searchParams.q
    : "https://dummyjson.com/products/search?limit=10&skip=" +
